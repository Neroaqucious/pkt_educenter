  ...
  <div class="card">
    <div class="card-body">
            ...
            <tr>
                ...
                <td class="text-center">
                  <a href="#" class="text-muted" id="actionDropdown" data-toggle="dropdown">
                    <span class="material-icons md-20 align-middle">more_vert</span>
                  </a>
      ...
      <div id="tab-3" class="tab-content">    
        <table class="table table-striped bg-white text-nowrap table-responsive" id="studentInterFailed">      
        <thead>
          <tr class="text-center">
            <th>No</th>
            <th>Applicant ID</th>
      ...
      <div id="tab-4" class="tab-content">    
        <table class="table table-striped bg-white text-nowrap table-responsive" id="studentDataLocal2">      
        <thead>
          <tr class="text-center">
            <th>No</th>
            <th>Applicant ID</th>
      ...
      <div id="tab-6" class="tab-content">    
        <table class="table table-striped bg-white text-nowrap table-responsive" id="studentDataLocal3">      
        <thead>
          <tr class="text-center">
            <th>No</th>
            <th>Applicant ID</th>
      ...
      <div id="tab-7" class="tab-content">    
        <table class="table table-striped bg-white text-nowrap table-responsive" id="ApplicantDataNew">      
        <thead>
          <tr class="text-center">
            <th>No</th>
            <th>Applicant ID</th>
      ...
      <div id="tab-8" class="tab-content">    
        <table class="table table-striped bg-white text-nowrap table-responsive" id="ApplicantDataInter">      
        <thead>
          <tr class="text-center">
            <th>No</th>
            <th>Applicant ID</th>
