    ...
    public function add() 
    {
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === false) {
                ...
                $data_financial_sponsor = array('fin_name' => $this->input->post('fin_name'), 'fin_age' => $this->input->post('fin_age'), 'fin_relationship' => $this->input->post('fin_relationship'), 'fin_address' => $this->input->post('fin_address'), 'tel' => $this->input->post('tel'), 'email' => $this->input->post('email'), 'fin_occupation' => $this->input->post('fin_occupation'), 'fin_work_place' => $this->input->post('fin_work_place'), 'fin_annual_income' => $this->input->post('fin_annual_income'),'fin_visa' => $this->input->post('fin_visa'), 'amount_saving_for_study_abroad' => $this->input->post('amount_saving_for_study_abroad'), 'amount_of_saving_which_proved' => $this->input->post('amount_of_saving_which_proved'), 'start_work_date' => $this->input->post('start_work_date'),);
    ...
    public function store() 
    {
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === false) {
                ...
                $userData = array('sign_file' => $this->session->userdata('__initial_regist_data') ['sign_file'], 'image_file' => $this->session->userdata('__initial_regist_data') ['image_file'],'family_file' => $this->session->userdata('__initial_regist_data') ['family_file'], 'jls_name' => $this->session->userdata('__initial_regist_data') ['jls_name'], 'applicant_name' => $this->session->userdata('__initial_regist_data') ['applicant_name'], 'applicant_name_kanji' => $this->session->userdata('__initial_regist_data') ['applicant_name_kanji'],'register_date' => $this->session->userdata('__initial_regist_data') ['register_date'],'appli_status' => $this->session->userdata('__initial_regist_data') ['appli_status'], 'date_of_birthday' => $this->session->userdata('__initial_regist_data') ['date_of_birthday'], 'place_birth' => $this->session->userdata('__initial_regist_data') ['place_birth'],'province' => $this->session->userdata('__initial_regist_data') ['province'],  'info_age' => $this->session->userdata('__initial_regist_data') ['info_age'], 'info_nationality' => $this->session->userdata('__initial_regist_data') ['info_nationality'], 'gender' => $this->session->userdata('__initial_regist_data') ['gender'], 'martial_status' => $this->session->userdata('__initial_regist_data') ['martial_status'], 'partaner_name' => $this->session->userdata('__initial_regist_data') ['partaner_name'], 'std_email' => $this->session->userdata('__initial_regist_data') ['std_email'], 'info_phone' => $this->session->userdata('__initial_regist_data') ['info_phone'], 'address' => $this->session->userdata('__initial_regist_data') ['address'], 'course_admission' => $this->session->userdata('__initial_regist_data') ['course_admission'], 'course_study_lengh' => $this->session->userdata('__initial_regist_data') ['course_study_lengh'], 'std_occupation' => $this->session->userdata('__initial_regist_data') ['std_occupation'], 'place_employment_school' => $this->session->userdata('__initial_regist_data') ['place_employment_school'], 'addr_employment_school' => $this->session->userdata('__initial_regist_data') ['addr_employment_school'], 'tel_employment_school' => $this->session->userdata('__initial_regist_data') ['tel_employment_school'], 'entry_age_ele_school' => $this->session->userdata('__initial_regist_data') ['entry_age_ele_school'], 'duration_jp_language_study' => $this->session->userdata('__initial_regist_data') ['duration_jp_language_study'], 'passport' => $this->session->userdata('__initial_regist_data') ['passport'], 'educational_school_name' => $this->session->userdata('__initial_regist_data') ['educational_school_name'], 'passport_no' => $this->session->userdata('__initial_regist_data') ['passport_no'], 'passport_data_issue' => $this->session->userdata('__initial_regist_data') ['passport_data_issue'], 'passport_data_exp' => $this->session->userdata('__initial_regist_data') ['passport_data_exp'],'passport_issue_authority' => $this->session->userdata('__initial_regist_data') ['passport_issue_authority'], 'military_service' => $this->session->userdata('__initial_regist_data') ['military_service'],'military_service_details' => $this->session->userdata('__initial_regist_data') ['military_service_details'], 'family_mail' => $this->session->userdata('__initial_regist_data') ['family_mail'], 'family_tel' => $this->session->userdata('__initial_regist_data') ['family_tel'], 'family_address' => $this->session->userdata('__initial_regist_data') ['family_address'],'created_at' => $this->session->userdata('__initial_regist_data') ['created_at'],'updated_at' => $this->session->userdata('__initial_regist_data') ['updated_at'],);
                ...
                $data_financial_sponsor = array('applicant_id' => $applicant_id, 'fin_name' => $this->session->userdata('__initial_regist_data2') ['fin_name'], 'fin_age' => $this->session->userdata('__initial_regist_data2') ['fin_age'], 'fin_relationship' => $this->session->userdata('__initial_regist_data2') ['fin_relationship'], 'fin_address' => $this->session->userdata('__initial_regist_data2') ['fin_address'], 'tel' => $this->session->userdata('__initial_regist_data2') ['tel'], 'email' => $this->session->userdata('__initial_regist_data2') ['email'], 'fin_occupation' => $this->session->userdata('__initial_regist_data2') ['fin_occupation'], 'fin_work_place' => $this->session->userdata('__initial_regist_data2') ['fin_work_place'],'fin_visa' => $this->session->userdata('__initial_regist_data2') ['fin_visa'], 'fin_annual_income' => $this->session->userdata('__initial_regist_data2') ['fin_annual_income'], 'amount_saving_for_study_abroad' => $this->session->userdata('__initial_regist_data2') ['amount_saving_for_study_abroad'], 'amount_of_saving_which_proved' => $this->session->userdata('__initial_regist_data2') ['amount_of_saving_which_proved'], 'start_work_date' => $this->session->userdata('__initial_regist_data2') ['start_work_date'],);
                ...
                for ($i = 0;$i < $count1;$i++) {                    
                    if($edu_name[$i] != Null){
                        $data_edu_history = array('applicant_id' => $applicant_id, 'edu_name' => $edu_name[$i], 'edu_address' => $edu_address[$i], 'edu_start_date' => $edu_start_date[$i], 'edu_end_date' => $edu_end_date[$i], 'edu_year' => $edu_year[$i],);
                ...
                for ($i = 0;$i < $count4;$i++) {
                    if($fam_name[$i] != Null){
                    $data_family_member = array('applicant_id' => $applicant_id, 'fam_name' => $fam_name[$i], 'fam_age' => $fam_age[$i],'fam_gender' => $fam_gender[$i],'fam_relationship' => $fam_relationship[$i],'fam_nationality' => $fam_nationality[$i], 'work_place' => $fam_work_place[$i], 'birthday' => $fam_birthday[$i], 'fam_occupation' => $fam_occupation[$i], 'annual_income' => $fam_annual_income[$i], 'fam_address' => $fam_address[$i], 'length_sevice' => $fam_length_sevice[$i]);
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === false) {
               ...
               // $checkdata2 = $this->Langschoolapplicant_Model->JLSCheck1($data_info, $update_info_id);
                ...
                $data_financial_sponsor = array('applicant_id' => $update_info_id, 'fin_name' => $this->input->post('fin_name'), 'fin_age' => $this->input->post('fin_age'), 'fin_relationship' => $this->input->post('fin_relationship'), 'fin_address' => $this->input->post('fin_address'), 'tel' => $this->input->post('tel'), 'email' => $this->input->post('email'), 'fin_occupation' => $this->input->post('fin_occupation'), 'fin_work_place' => $this->input->post('fin_work_place'), 'fin_visa' => $this->input->post('fin_visa'),'fin_annual_income' => $this->input->post('fin_annual_income'), 'amount_saving_for_study_abroad' => $this->input->post('amount_saving_for_study_abroad'), 'amount_of_saving_which_proved' => $this->input->post('amount_of_saving_which_proved'), 'start_work_date' => $this->input->post('start_work_date'),);
