       ...
       // var_dump($this->data['result14']);
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === false) {
                ...
                $data_info = array('jls_name' => $this->input->post('jls_name'),'register_date' => $this->input->post('register_date'), 'interview_date' => $this->input->post('interview_date'), 'inter_fail_date' => $this->input->post('inter_fail_date'), 'admission_date' => $this->input->post('admission_date'), 'adm_complete_date' => $this->input->post('adm_complete_date'), 'tracking_code' => $this->input->post('tracking_code'), 'data_expired_date' => $this->input->post('data_expired_date'), 'coe_date' => $this->input->post('coe_date'), 'cancel_date' => $this->input->post('cancel_date'),'cancel_times' => $this->input->post('cancel_times'), 'inter_fail_times' => $this->input->post('inter_fail_times'),'coe_fail_date' => $this->input->post('coe_fail_date'), 'coe_pass_date' => $this->input->post('coe_pass_date'),  'applicant_name' => $this->input->post('applicant_name'), 'applicant_name_kanji' => $this->input->post('applicant_name_kanji'),'appli_status' => $this->input->post('appli_status'),'interview_date' => $this->input->post('interview_date'), 'date_of_birthday' => $this->input->post('date_of_birthday'), 'place_birth' => $this->input->post('place_birth'),'province' => $this->input->post('province'),'info_age' => $this->input->post('info_age'), 'info_nationality' => $this->input->post('info_nationality'), 'gender' => $this->input->post('gender'), 'martial_status' => $this->input->post('martial_status'), 'partaner_name' => $this->input->post('partaner_name'), 'std_email' => $this->input->post('std_email'), 'info_phone' => $this->input->post('info_phone'), 'address' => $this->input->post('address'), 'course_admission' => $this->input->post('course_admission'), 'course_study_lengh' => $this->input->post('course_study_lengh'), 'occupation' => $this->input->post('occupation'), 'place_employment_school' => $this->input->post('place_employment_school'), 'addr_employment_school' => $this->input->post('addr_employment_school'), 'tel_employment_school' => $this->input->post('tel_employment_school'), 'entry_age_ele_school' => $this->input->post('entry_age_ele_school'), 'duration_jp_language_study' => $this->input->post('duration_jp_language_study'), 'passport' => $this->input->post('passport'), 'educational_school_name' => $this->input->post('educational_school_name'), 'passport_no' => $this->input->post('passport_no'), 'passport_data_issue' => $this->input->post('passport_data_issue'), 'passport_data_exp' => $this->input->post('passport_data_exp'),'passport_issue_authority' => $this->input->post('passport_issue_authority'), 'military_service' => $this->input->post('military_service'),'military_service_details' => $this->input->post('military_service_details'), 'family_mail' => $this->input->post('family_mail'), 'family_tel' => $this->input->post('family_tel'), 'family_address' => $this->input->post('family_address'),'created_at' => date('Y-m-d H:i:s'),'updated_at' => date('Y-m-d H:i:s'),);
