...
function initMap() {
	...
	/* Theme Map */	
	var temeMap = new google.maps.Map(document.getElementById('temeMap'), {
	...
	/* Traffic Map */
	var trafficMap = new google.maps.Map(document.getElementById('trafficMap'), {
      zoom: 13,
    ...
    var heatlayermap = new google.maps.visualization.HeatmapLayer({
      data: getPoints(),
      map: heatMap
    });
